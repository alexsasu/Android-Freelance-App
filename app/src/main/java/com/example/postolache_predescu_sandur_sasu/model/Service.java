...
//    }
    ...
    public Service(Job job, City city, @NonNull User user, @NonNull Double price, @NonNull String description, @NonNull Integer experienceYears, @NonNull String workSchedule) {
        this.idService = newIdService;
